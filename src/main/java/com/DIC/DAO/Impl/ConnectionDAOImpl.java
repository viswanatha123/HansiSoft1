...
//********************** getExceptionValue(long datasetid,java.util.Date createdOnDate) *********************
    ...
    public String indianCurrence(int price)
    {
		   		...
		   		String totalPrice=firstOrig+","+second+" /-   ";
  ...
  //************************************AgriculturalDetails******************************************//
    ...
    public String updatePlotDataEntry(PlotsDataEntryModel plotsDataEntryModel)
    {
        ...
        try {
            ...
            pstmt.setInt(3, plotsDataEntryModel.getPersqft());
		    ...
		    pstmt.setInt(22, plotsDataEntryModel.getPersqft() * (plotsDataEntryModel.getLength() * plotsDataEntryModel.getWidth()));
